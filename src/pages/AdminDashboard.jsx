...
export default function AdminDashboard() {
  ...
  // Wait for the session to restore before deciding to redirect.
  if (loading) {
    return (
      <div className="pt-24 sm:pt-28 pb-10 min-h-screen bg-page flex items-center justify-center">
        <svg className="animate-spin h-6 w-6 text-stone-400" viewBox="0 0 24 24" fill="none">
